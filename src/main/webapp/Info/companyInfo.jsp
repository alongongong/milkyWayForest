...
<link rel="stylesheet" href="../css/companyInfo.css"> <!-- PC전용 -->
</head>
	<!-- Info 배너사진 -->
	<img src="../image/Infobanner.png" alt="Infobanner" width="100%" >

	<body>
		<div class="info1">
			<a><img src="../image/cp_information_img01.jpg" alt="info" width="83%"></a>
			<span><em><strong>"커피 이상의 특별한 경험을 소개합니다."</strong></em></span>
		</div>
		...
		<div class="info2">
				<p>
				<a href="#a"><img src="../image/cp_infomt_img.png" alt="cp_infofnp" align="left" ></a>
				<div>
					㈜스타벅스커피 코리아는<br>
					1999년 이대점 1호점을 시작으로 모든 매장을 직영하며,<br>
					지역사회 속에서 일상을 풍요롭게 하는<br>
					특별한 스타벅스 경험을 전달하면서<br>
					업계를 선도하는 기업으로 성장해 오고 있습니다.<br>
					</div></p>
			</div>
			
			<div class="info3"></div>
				<p><a><img src="../image/cp_information_st_img01.jpg" alt="cp_information_st"></a></p>
			...
			다양한 이해관계자들과 지역사회를 배려하는 사회적 책임과 성장을 함께 추구하고 있습니다.<br>
 			...
 			<a><img src="../image/cp_infomtSt_img.png" alt="cp_infomtSt" align="right"></a>
 			<div>
			...
			지역사회와 커피 지식을 나누고 있습니다.<br>
 			...
 			<div class="info6"></div>
			<div>
			오늘날 스타벅스는 전세계 각국에서 수만여 명의 파트너들이 근무하는 세계 최고의 커피 전문 회사로,<br>
			...
			<br>
 			<a><img src="../image/cp_infomtStbtm_img_img.jpg" alt="cp_infomtStbtm"></a>
			가까운 스타벅스 매장이나 트위터, 페이스북, 유튜브를 방문하면 매일 새로운 스타벅스를 경험할 수 있습니다.<br>
			<br>
			</div>
		</main>
</body> 
