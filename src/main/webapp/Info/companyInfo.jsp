...
<link rel="stylesheet" href="/milkyWayForest//css/companyInfo.css">
	...
	<div id="companyInfo">
		<div id="leftDiv">
			<div class="pic1">
				<img src="/milkyWayForest/image/cp_information_img01.jpg"
				 alt="cp_information">
			</div>
			...
			<div class="text4">
	 		...
	 		<p class="text5">
	 			은하숲은 국내에 새로운 커피 문화를 소개하며, 국내 협력사와의 동반성장, 글로벌 인재 양성, 고용창출, 환경보호 등<br>
	 		...
	 		<div class="third_block">
				...
				<p class="pic4">
					<img src="/milkyWayForest/image/cp_infomtSt_img1.PNG" alt="cp_infomtSt">
				</p>
	 		</div>
	 		
	 		<div class="final_block">
	 			<p class="pic5">
	 				<img src="/milkyWayForest/image/cp_infomtStbtm_img_img.jpg" alt="cp_infomtStbtm">
	 			</p>
				<p class="text8">
