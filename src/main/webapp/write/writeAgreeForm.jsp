				...
				<div id="writeAgreeContent">
	                ...
	                <ul><br>
	               	...
	               	<ul><br>
	               		...
	               		<li>3. 3. e-프리퀀시 바코드의 구체적인 운영 방침이나 활용 방법 및 혜택은 회사의 마케팅 정책에 따라 변경될 수 있으며, 이에 대해서는 별도의 방법으로 사전에 안내해 드립니다.</li>
	               	</ul><br>
	               	<p>제 3 장 사이렌 오더 서비스</p><br>
	               	<p>제 16 조 적용범위</p><br>
	               	<ul><br>
	               		<li>회원은 스타벅스 모바일 애플리케이션을 통해 제공하는 사이렌 오더 서비스를 이용할 수 있으며, 본 장의 규정은 사이렌 오더 서비스를 이용하는 회원들에게 적용됩니다.</li>
	               	</ul><br>
	               	<p>제 17 조 제공되는 사이렌 오더 서비스</p>
	               	<ul><br>
	               		<li>회사가 제공하는 사이렌 오더 서비스는 다음 각 호와 같습니다.</li>
	               		<ul><br>
	               			<li>가. 스타벅스 모바일 애플리케이션을 통한 결제 및 주문 서비스</li>
	               			<ul><br>
	               	...
	               	<p>제 18 조 사이렌 오더 서비스의 이용 및 변경</p>
	               	<ul><br>
	               	...
	               	<p>제 19 조 결제 및 주문 취소 등</p>
	               	<ul><br>
	               		<li>1. 사이렌 오더 서비스 내 판매 상품 등의 주문 요청에 대하여 회사가 주문을 승인함으로써 회사와 회원 사이에 판매 상품 등에 관한 매매계약이 성립합니다.</li>
	               		<li>2. 본 서비스의 결제에 따른 대금 지급 방법은 다음 각호의 방법 중 가능한 방법으로 할 수 있습니다. 회사는 회원의 지급방법에 대하여 어떠한 명목의 수수료도 추가하여 징수하지 않습니다.</li>
	               		<ul>
	               		...
	               		<li>6. 제5항의 규정에도 불구하고 다음 각 호의 경우에 회사는 즉시 결제 취소를 위한 조치를 취하여야 하고, 회사가 결제 취소 및 그로 인해 발생한 일체의 비용을 부담합니다.</li>
	               		<ul>
	               		...
	               		<li>9. 회원이 결제 및 주문 전송 이후 상품을 수령하지 않는 경우, 주문 취소가 받아들여지지 아니할 수 있으며, 이로 인하여 회원에게 발생하는 손해에 대하여 회사는 고의 또는 과실이 없는 한 책임을 부담하지 않습니다. 다만 결제 및 주문 동시에 판매가 완료되는 메뉴인 경우, 매장에서 주문 승인을 하지 않으며, 회원에게 해당 사유가 푸시 알림으로 발송됩니다. 이 경우, 회원은 [히스토리] 메뉴에서 결제 취소하기 기능으로 즉시 결제를 취소할 수 있고, 그렇지 않으면 익일 (24시간 이내) 자동으로 취소됩니다.</li>
	               		<li>10. 회원이 홀케이크 수령을 원하는 날짜로부터 3~15일 이전에 주문의 예약/수정/취소가 가능합니다. 단, 화요일에 수령을 원하는 경우에는 전 주 금요일까지 예약/수정/취소 가능하며, 신상품 홀케이크 출시, 공휴일 및 명절 연휴 등에는 예약 가능 일정이 변동될 수 있습니다. 크리스마스 홀케이크, 사이렌 오더 전용 홀케이크 등 일부 시즌 홀케이크의 경우에는 명시된 예약 기간에만 주문 예약/수정/취소가 가능하며, 명시된 수령 기간에만 수령이 가능합니다. 회사는 이에 대한 사실을 개별 상품 등에 대한 안내 또는 결제 화면 등에서 고지하고, 회원이 이에 동의하여야 결제가 가능한 것으로 할 수 있습니다.</li>
						...
						<li>13. 주문 및 예약 세부 상태 내역은 별첨한 채널을 통해 안내합니다.</li>
						<li>별첨</li>
					</ul><br>
					<p>제 20 조 홀케이크 선물하기</p>
					<ul><br>
					...
					<p>제 21 조 사이렌 오더 서비스 이용 회원의 혜택</p>
					<ul><br>
					...
					<ul><br>
						...
						<ul>
							...
							<li>다. 회사는 e-Gift Item의 발행 시 다음 사항을 표시합니다.</li>
							<ul>
								<li>① 발행자</li>
						...
						<li>5. e-Gift Item의 구매/전송이력의 관리 및 제3자 전송 지원</li>
						<ul>
							...
							<li>다. 회사는 구매한 e-Gift Item의 제3자 전송(양도)을 희망하는 이용자의 편의를 위하여, 구매자의 휴대기기에 설치된 전송 수단 중 일부를 전송 수단으로 사용할 수 있도록 지원하되, 휴대폰 문자 메시지를 통한 전송을 희망하는 경우에 한하여, 회사는 회사가 보유 또는 계약하여 사용 중인 휴대폰 문자 메시지 발송 플랫폼을 통해 이를 무상 발송 지원합니다. 단, 회사가 제공하지 않는 기타 전송 수단을 통한 전송 요청에 대하여, 회사는 전송을 지원하지 않으며 비용을 부담할 책임이 없습니다.</li>
						...
						<li>7. 서비스 및 e-Gift Item의 사용</li>
						<ul>
							<li>가. e-Gift Item은 유효기간 내에만 사용할 수 있으며, 사용 가능한 매장의 조건은 각 상품별 e-Gift Item 증서에 기재된 바에 따릅니다.</li>
							<li>나. e-Gift Item 권면 기재 상품이 아닌 타 상품으로의 변경 사용 또는 권면 기재 개별 옵션의 변경은 다음 각 호의 조건을 충족하는 경우에 한하여 허용됩니다.</li>
							<ul>
								<li>① 제휴할인 등을 적용한 후 최종 결제할 금액이 제시한 e-Gift Item의 권면 기재 금액과 동일하거나 초과하는 경우</li>
								<li>② ①호의 최종 결제금액이 권면 기재금액을 초과할 경우 추가결제 필요
							</ul>
							<li>다. 회사는 다음 각 호에 해당하는 경우 발행된 e-Gift Item의 전부 또는 일부의 교환을 제한하거나 사용을 중지할 수 있습니다.</li>
							<ul>
							...
							<li>라. 회사는 다음 각 호에 해당하는 경우 e-Gift Item의 구매, 사용 및 e-Gift Item 서비스의 일부 또는 전부의 이용을 제한하거나 중지시킬 수 있습니다.</li>
							<ul>
					...
					<ul><br>
						...
						<ul>
							...
							<li>다. 회사는 다음 각 호에서 예시하는 바와 같이 이용자가 불법 또는 부정한 방법으로 e-Gift Item 서비스를 이용하거나 과실에 해당하는 행위를 하여 이용자 상호 간 또는 이용자와 제3자 상호 간에 분쟁이 발생하였을 때 회사의 책임을 주장하는 자가 회사의 귀책사유를 객관적으로 입증하지 않는 한 이에 개입할 의무가 없으며 분쟁으로 발생하는 손해를 배상할 책임이 없습니다.</li>
							<ul>
					...
					<ul><br>
						...
						<ul>
							...
							<li>나. 회사가 제공하는 e-Gift Item 서비스로 인하여 이용자에게 손해가 발생하였을 때 그러한 손해가 회사의 고의나 과실로 인하여 발생하였다면 회사가 그 책임을 부담하며, 책임의 범위는 통상 손해에 한합니다.
						</ul>
						<li>2. 이용자의 의무</li>
						<ul>
							<li>가. 이용자는 e-Gift Item 서비스를 이용할 때 다음 각 호의 행위를 해서는 안 됩니다.</li>
							<ul>
						...
						<ul>
							...
							<li>다. 회원은 e-Gift Item 서비스를 이용할 때 다음 각 호의 행위를 해서는 안 됩니다.</li>
							<ul>
					...
					<p>제 28 조 Delivers 서비스의 이용 및 변경</p>
					<ul><br>
					...
					<p>제 29 조 Delivers 서비스 결제 및 주문 취소 등</p>
					<ul><br>
						<li>1. Delivers 서비스 내 판매 상품 등의 주문 신청에 대하여 회사가 주문을 승인함으로써 회사와 회원 사이에 판매상품 등에 관한 매매계약이 성립합니다.</li>
						<li>2. Delivers 서비스의 결제에 따른 대금 지급 방법은 다음 각 호의 방법 중 가능한 방법으로 할 수 있습니다. 회사는 회원의 지급 방법에 대하여 어떠한 명목의 수수료도 추가하여 징수하지 않습니다.</li>
						<ul>
							<li>가. Starbucks Card</li>
							<li>나. 신용카드</li>
						</ul>
						...
						<li>6. 제5항의 규정에도 불구하고 다음 각 호의 경우에는 회사는 즉시 결제 취소를 위한 조치를 취하여야 하고, 회사가 결제 취소 및 그로 인해 발생한 일체의 비용을 부담합니다.</li>
						<ul>
							<li>가. 제공된 상품 등이 회원이 결제한 상품 등의 내용과 현저히 상이할 경우</li>
						...
						<li>10. 회원이 결제 및 주문 전송 이후 상품을 수령하지 않거나 상품 수령자가 수령을 원치 않는 경우, 주문 취소가 받아들여지지 아니할 수 있으며, 이로 인하여 발생하는 손해에 대한 일체의 비용과 책임은 회원이 부담합니다. 다만 결제 및 주문과 동시에 상품 판매가 완료되었거나 상품 제공이 불가한 경우 등이 발생하면 매장에서 주문 승인을 하지 않으며 회원에게 해당 사유가 푸시 알림으로 발송됩니다. 이 경우, 결제는 자동으로 즉시 취소되며, 즉시 자동 취소가 되지 않는 경우에는 익일 (24시간 이내) 자동으로 취소됩니다.</li>
					...
					<p>제30 조 Delivers 서비스 이용 회원의 혜택</p>
					<ul><br>
					...
					<p>제 32 조 에코매장 이용에 관한 총칙</p>
					<ul><br>
						<li>1. 에코매장 이용</li>
						<ul>
							<li>에코매장에서 이용자에게 제공하는 서비스는 다음 각 호와 같습니다.</li>
							<ul>
								<li>가. 리유저블컵 운영</li>
								<ul>
					...
					<p>제 33 조 에코매장 내 서비스의 이용 및 변경</p>
					<ul><br>
					...
					<p>제 34 조 에코매장 내 결제 및 주문 취소 등</p>
					<ul><br>
						<li>1. 에코매장에서 이용자의 리유저블컵을 포함한 상품 등의 주문에 대하여 회사가 이를 승인함으로써 계약이 성립합니다.</li>
						<li>2. 이용자가 결제 시 대금 지급 방법은 다음 각 호의 방법 중 가능한 방법으로 할 수 있습니다. 단, 회원은 사이렌오더를 통해 리유저블컵을 포함하여 상품 등을 결제하는 경우 Starbucks Card로만 결제하여야 합니다.</li>
						<ul>
							<li>가. Starbucks Card</li>
							<li>나. 현금</li>
							<li>다. 신용/체크카드</li>
					...
					<p>제 38 조 Gift 배송하기 서비스의 이용 및 변경</p>
					<ul><br>
					...
					<p>제 40 조 계약의 성립</p>
					<ul><br>
						<li>1. 회사는 이용자의 구매 신청에 대하여 다음 각 호에 해당하면 승낙하지 않을 수 있습니다.</li>
						<ul>
					...
					<p>제 41 조 수신 확인 통지 ∙ 구매 신청 변경 및 취소</p>
					<ul><br>
					...
					<p>제 46 조 청약철회</p>
					<ul><br>
						<li>1. 회사와 상품 등의 구매에 관한 계약을 체결한 이용자는 계약 내용에 관한 서면을 교부 받은 날 또는 수신 확인의 통지를 받은 날로부터 7일 이내에 청약의 철회를 할 수 있습니다. 만일 그 서면을 교부 또는 수신확인의 통지를 받은 때보다 상품 등의 공급이 늦게 이루어진 경우에는 상품 등의 공급을 받거나 공급이 개시된 날부터 7일 이내에 청약의 철회를 할 수 있습니다. 다만, 청약철회에 관하여 전자상거래 등에서의 소비자 보호에 관한 법률에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다.</li>
						<li>2. 이용자는 상품 등을 배송 받은 경우 다음 각 호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.</li>
						<ul>
					...
					<ul><br>
						...
						<li>2. 회사는 위 대금을 환급함에 있어서 이용자가 신용카드 그 밖에 전자상거래 등에서의 소비자보호에 관한 법률 시행령 등이 정하는 결제 수단으로 상품 등의 대금을 지급한 때에는 지체 없이 당해 결제 수단을 제공한 사업자로 하여금 상품 등의 대금 청구를 정지 또는 취소하도록 요청합니다. 단, 사용처가 회사로 제한되어 있는 e-Gift Item 또는 제휴사 모바일 상품권으로 결제 후 익일 이후 결제 취소하는 경우 회사는 Starbucks Card에 환급할 금액을 적립하여 환급합니다.</li>
					...
					<ul><br>
						...
						<ul>
							...
							<li>다. 회사는 다음 각 호에서 예시하는 바와 같이 이용자가 불법 또는 부정한 방법으로 Gift 배송하기 서비스를 이용하거나 과실에 해당하는 행위를 하여 이용자 상호 간 또는 이용자와 제3자 상호 간에 분쟁이 발생하였을 때 회사의 책임을 주장하는 자가 회사의 귀책사유를 객관적으로 입증하지 않는 한 이에 개입할 의무가 없으며 분쟁으로 발생하는 손해를 배상할 책임이 없습니다.</li>
							<ul>
					...
					<p>제 8 장 기타</p><br>
					<p>제 50 조 전자영수증(e-Receipt & History)의 발행 및 거래 내역의 확인</p>
					<ul><br>
						...
						<li>5. 회사는 다음 각 호에 해당하는 경우, “전자영수증(e-Receipt & History)” 서비스 전부 또는 일부를 제한하거나 중지할 수 있습니다.</li>
						<ul>
						...
						<li>6. 회사는 관련 법령에 의거하여 회원과의 거래내역을 거래가 발생한 날로부터 최대 5년 간 보관하며, 해당 기간 동안 회원은 회사가 제공하는 홈페이지 및 스타벅스 모바일 애플리케이션을 통하여 열람 및 확인할 수 있습니다. e-Gift Card의 거래내역은 e-Gift Card 선물내역에서 최대 1년 간의 거래내역 확인이 가능하며, e-Gift Item의 거래내역은 e-Gift Item 보낸 선물 메뉴에서 최대 5년 간의 거래내역을 확인할 수 있습니다.</li>
					</ul><br>
					<p>제 51 조 약관의 해석 등
					<ul><br>
					...
					<p>제 54 조 관할법원</p>
					<ul><br>	
						<li>본 약관과 관련하여 회사와 이용자 사이에 발생한 분쟁에 관한 소송은 회사의 소재지를 관할하는 법원 또는 민사소송법상의 관할법원을 관할법원으로 합니다.
					</ul><br>
					<p>본 이용약관은 2021년 8월 24일부터 시행합니다.</p>
				</div>
			</div>
		</li>
				...
				<div id="writeAgreeContent">
    				...
    				<ul>
    					...
    					<table border="1">
    						...
    						<tr>
    							<td>항목</td>
    							<td>성명, 생년월일, 성별, 아이디, 비밀번호, 휴대전화번호, E-Mail, DI (Duplication information)</td>
    						</tr>
    						<tr>
    							<td>목적</td>
    							<td>- 회원가입(홈페이지. 스타벅스 리워드), 본인확인
    								- 서비스 제공
    						...
    						<tr>
    							<td>보유 및 이용기간</td>
    							<td>회원 탈퇴 후 30일간 보관 (반복 재가입 등의 방법을이용한 서비스 부정이용 방지) 또는 관계법령에 의한 별도 보존기간 (2. 관계법령에 의한 개인정보 보존기간참고)</td>
    						</tr>
    					</table>
    				</ul>
    				<br>
    				<ul>
    					<li>2. 관계법령에 의한 개인정보 보존기간</li>
    					<ul>
